    ...
    <div className="space-y-4 pb-6 border-b border-zinc-800 last:border-0 last:pb-0">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-2">
        <div>
          ...
          <div className="text-sm text-yellow-500">{company}</div>
        ...
        <ul className="space-y-2">
          {achievements.map((achievement, index) => (
            <li key={index} className="flex text-sm text-zinc-300">
              <CheckCircle2 className="w-4 h-4 mr-2 text-amber-700 flex-shrink-0 mt-0.5" />
      ...
      <div>
        <h5 className="text-sm font-medium text-zinc-400 mb-2">Skills & Approaches</h5>
