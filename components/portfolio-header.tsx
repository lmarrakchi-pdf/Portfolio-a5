    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center group">
          <div className="font-bold text-xl relative overflow-hidden transition-transform duration-300 group-hover:scale-105">
            <span className="text-white">Lmarrakchi</span>
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-amber-100 to-orange-700 transition-all duration-300 group-hover:w-full"></span>
          </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? "text-amber-100" : "text-zinc-400 hover:text-white",
                )}
              >
                <span className="relative z-10">{item.label}</span>

                {/* Hover effect - subtle background glow */}
                <span className="absolute inset-0 bg-amber-700/0 rounded-md group-hover:bg-amber-700/10 transition-all duration-300"></span>

                {/* Hover effect - bottom border */}
                <span
                  className={cn(
                    "absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-amber-100 to-orange-700 transition-all duration-300 group-hover:w-4/5",
                    isActive && "w-4/5",
                  )}
                ></span>
              </Link>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? "text-amber-100 border-amber-100/30" : "text-zinc-300 hover:text-white hover:pl-5",
                )}
              ...
              >
                ...
                <span
                  className={cn(
                    "absolute left-0 top-1/2 -translate-y-1/2 w-0 h-1/2 bg-gradient-to-b from-amber-100/20 to-orange-700/20 transition-all duration-300 group-hover:w-1",
                    isActive && "w-1",
                  )}
                ></span>
              </Link>
