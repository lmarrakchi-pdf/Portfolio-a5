...
export function AnimationSettingsPanel() {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50">
      ...
      >
        <Settings className="h-5 w-5" style={{ color: "#f3edb9" }} />
      </Button>
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm font-medium flex items-center">
                <Zap className="w-4 h-4 mr-2" style={{ color: "#f3edb9" }} />
                Animation Settings
              </h3>
              <Button
                size="icon"
                      ...
                      {presetOptions.map((preset) => (
                        <Button
                          ...
                          className={`h-auto py-2 px-1 flex flex-col items-center justify-center text-xs ${
                            settings.preset === preset.value ? "border-zinc-600" : ""
                          }`}
                          style={
                            settings.preset === preset.value
                              ? {
                                  background:
                                    "linear-gradient(to right, rgba(243, 237, 185, 0.2), rgba(180, 83, 9, 0.2))",
                                  borderColor: "#f3edb9",
                                }
                              : {}
                          }
      ...
      <div className="h-20 bg-zinc-800/50 rounded-md overflow-hidden">
        ...
        >
          <div className="text-xs text-center">
            <div className="mb-1" style={{ color: "#f3edb9" }}>
              {animationType
                .split("-")
